...
def main():
    ...
    parser = argparse.ArgumentParser(description="Qwen-VL M3CoT baseline training")
    ...
    logging.basicConfig(
        filename=os.path.join(save_dir, "qwen_m3cot_base_train.log"),
        level=logging.DEBUG,
    ...
    for epoch in range(configs.resume, configs.num_epochs):
        ...
        collator = LazyM3CoTBaseCollator(
            tokenizer=tokenizer,
            processor=processor,
            label_pad_token_id=-100,
            max_length=3400,
