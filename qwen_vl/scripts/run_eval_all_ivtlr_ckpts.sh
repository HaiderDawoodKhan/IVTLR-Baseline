...
# M3CoT evaluation
python infer_m3cot.py --checkpoint output/qwen_IVTLR_m3cot/epoch_16_full_model_fp32.pth --run_tag epoch_16
...
python infer_sqa.py --config args/qwen_sqa.yaml --checkpoint output/qwen_IVTLR_sqa/epoch_16_full_model_fp32.pth --run_tag epoch_16
