...
python infer_m3cot_base.py --checkpoint output/qwen_IVTLR_m3cot_base/epoch_16_full_model_fp32.pth --run_tag epoch_16
...
python infer_sqa_base.py --config args/qwen_sqa.yaml --checkpoint output/qwen_IVTLR_sqa_base/epoch_16_full_model_fp32.pth --run_tag epoch_16
